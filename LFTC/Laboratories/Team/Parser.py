...
class Parser:
    ...
    def fromFile(self,fileName):
        with open(fileName) as file:
            self.terminals = Parser.parseLine(file.readline())
            self.nonterminals = Parser.parseLine(file.readline())
            ...
            self.productions = Parser.parseProductions(self.productions)
